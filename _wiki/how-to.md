...
카더라는 여러분이 편입 공부를 하시며 수도 없이 많이 마주치게 될 것입니다. 그렇기에 굳이 그걸 검증할 수 있더라도 매번 그게 사실인지 아닌지 구별하기위해 질문하실 필요가 없습니다.  
위에 말이 이해가 잘 되지 않는다면 그리고 본인이 카더라 통신을 듣고서 갑갑하여 이 위키에 오셨다면 [[mythNtruth]]{이 문서}를 참조하시길 바랍니다.
